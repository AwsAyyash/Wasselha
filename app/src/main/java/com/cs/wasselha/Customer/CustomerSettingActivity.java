...
public class CustomerSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(CustomerSettingActivity.this);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT, url, requestData,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Intent intent = new Intent(CustomerSettingActivity.this, MainCustomerActivity.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(CustomerSettingActivity.this, "Email or phone is used please select another email or phone number", Toast.LENGTH_SHORT).show();
